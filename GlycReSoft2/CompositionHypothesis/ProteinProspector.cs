...
namespace GlycReSoft.CompositionHypothesis
{
    ...
    /// <summary>
    /// Extract and represent relevant information from the a ProteinProspector MS-Digest
    /// </summary>
    public class MSDigestReport
    {
        ...
        public MSDigestReport(XmlDocument data)
        {
            ...
            //DatabaseEntries = new List<MSDigestDatabaseEntry>();
        ...
        public void Parse(XmlDocument data)
        {
            ...
            foreach (XmlNode peptideNode in data.SelectNodes(".//peptide"))
            {
                ...
                peptideObj.number = Convert.ToInt32(peptideNode.SelectSingleNode(".//protein_index").InnerText);
